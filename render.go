...
var md = goldmark.New(
	goldmark.WithExtensions(extension.GFM), // tables, strikethrough, autolink
	goldmark.WithRendererOptions(
		html.WithHardWraps(), // blog likhte waqt enter dabao toh line break dikhna chahiye
	),
	// Note: raw HTML deliberately allow nahi kiya. Blog LAN pe khulta hai,
	// aur kisi ne <script> daal diya toh sabke browser me chalega. Nahi chahiye.
)
